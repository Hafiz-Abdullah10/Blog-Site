...
const Header = () => {
    ...
    return (
        ...
        text-gray-700 font-serif'>Our Own <span className=' text-primary'>Blogging</span>
                    <br /> Platform</h1>

                <p className='my-6 sm:my-8 max-w-2xl m-auto max-sm:text-xs text-gray-500 font-serif'>
                    A full-featured blogging
                    website built using the MERN stack, designed for users to create,
                    edit, and manage posts seamlessly.</p>
