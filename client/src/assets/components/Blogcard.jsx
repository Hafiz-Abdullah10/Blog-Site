...
const Blogcard = ({blog}) => {
  ...
  return (
    ...
    overflow-hidden shadow hover:scale-102 hover:shadow-primary/25 duration-300 cursor-pointer'>
        ...
        text-primary text-xs font-serif'>{category}</span>

        <div className='p-5'>
            <h5 className='mb-2 font-medium text-gray-900 font-serif'>{title}</h5>
            <p className='mb-3 text-xs text-gray-600 font-serif' 
