...
import { assets, blog_data, comments_data } from '../assets'
...
const Blog = () => {
  ...
  return data ? (
    <div className='relative'>
      <img src={assets.gradientBackground} alt="Gradientbg"
      ...
      <div className='text-center mt-20 text-gray-600'>
        ...
        <h2 className='my-5 max-w-lg truncate mx-auto font-serif'>
          {data.subTitle}
        </h2>
      ...
      <div className='mx-5 max-w-5xl md:mx-auto my-10 mt-6'>
        ...
        <div className='mt-14 mb10 max-w-3xl mx-auto'>
          <p className='font-semibold mb-4 font-serif'>Comments ({comments.length})</p>
          <div className='flex flex-col gap-4'>
            {comments.map((item, index) => (
              <div key={index} className='relative bg-primary/2 border border-primary/5 max-w-xl
            p-4 rounded text-gray-600 font-serif'>
                <div className='fex items-center gap-2 mb-2'>
        ...
        <div className='max-w-3xl mx-auto'>
          ...
          <form onSubmit={addComment} className='flex flex-col items-start gap-4 max-w-lg'>
            ...
            <textarea onChange={(e) => setContent(e.target.value)} value={content}
              placeholder='Comment' required className='w-full p-2 border 
